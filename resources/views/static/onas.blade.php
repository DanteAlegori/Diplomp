...
@section('content')
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-md-8">
        <h1 class="text-center mb-5">{{ __('О нас') }}</h1>
        <p class="lead text-center mb-5">{{ __('Мы - команда, которая любит и ценит традиции сельского хозяйства. Мы сотрудничаем с музеем, чтобы сохранить историю сельской жизни и рассказать об этом миру.') }}</p>
      </div>
    </div>
    <div class="row justify-content-center">
      <div class="col-md-6 text-center mb-5">
       
        <h3>{{ __('Наша команда') }}</h3>
        <p>{{ __('Мы - эксперты в области сельского хозяйства, а также любители этой отрасли. Мы работаем с увлечением, чтобы рассказать о красоте сельской жизни и сохранить ее историю. Наша команда состоит из высококвалифицированных специалистов с многолетним опытом работы в сфере сельского хозяйства.') }}</p>
      </div>
      <div class="col-md-6 text-center">
        <h3>{{ __('Наши контакты') }}</h3>
